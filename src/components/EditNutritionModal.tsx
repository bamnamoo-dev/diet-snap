      ...
      <div className="bg-[#18181b] border border-neutral-800 w-full max-w-md rounded-t-3xl sm:rounded-2xl p-5 shadow-2xl space-y-4">
        ...
        <div className="flex items-center justify-between border-b border-neutral-800 pb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-bold text-base text-white whitespace-nowrap">식단 상세 수치 직접 수정</h3>
          </div>
          <button
            onClick={onClose}
            className="p-1.5 text-neutral-400 hover:text-white rounded-lg hover:bg-neutral-800 shrink-0"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div>
            <label className="text-xs font-semibold text-neutral-400 block mb-1.5 flex items-center gap-1 whitespace-nowrap">
          ...
          <div>
            <label className="text-xs font-semibold text-neutral-400 block mb-1 whitespace-nowrap">메뉴명</label>
            <input
              type="text"
              value={form.name}
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <div>
              <label className="text-xs font-semibold text-neutral-400 block mb-1 whitespace-nowrap">총 칼로리 (kcal)</label>
              <input
                type="number"
                value={form.calories}
            ...
            <div>
              <label className="text-xs font-semibold text-neutral-400 block mb-1 whitespace-nowrap">추정 중량 / 단위</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-3 gap-2 pt-1">
            <div>
              <label className="text-[11px] font-semibold text-blue-400 block mb-1 whitespace-nowrap">탄수화물 (g)</label>
              <input
                type="number"
                value={form.carbs}
            ...
            <div>
              <label className="text-[11px] font-semibold text-emerald-400 block mb-1 whitespace-nowrap">단백질 (g)</label>
              <input
                type="number"
                value={form.protein}
            ...
            <div>
              <label className="text-[11px] font-semibold text-amber-400 block mb-1 whitespace-nowrap">지방 (g)</label>
              <input
                type="number"
                value={form.fat}
          ...
          <div>
            <label className="text-xs font-semibold text-neutral-400 block mb-1 whitespace-nowrap">인스타 감성 한 줄 평</label>
            <input
              type="text"
          ...
          <div className="pt-2">
            <button
              type="submit"
              className="w-full py-3 bg-emerald-500 hover:bg-emerald-400 text-neutral-950 font-bold rounded-xl text-sm flex items-center justify-center gap-1.5 shadow-lg shadow-emerald-500/20 transition active:scale-[0.98] whitespace-nowrap"
            >
              <Check className="w-4 h-4 shrink-0" /> <span className="whitespace-nowrap">캔버스에 즉시 반영하기</span>
            </button>
          </div>
        </form>
      </div>
